...
class LeprixSpider(scrapy.Spider):
    ...
    proxies = {'http://3.229.216.245:3306'}  # , 'https': 'socks5://127.0.0.1:1080'
    headers = {
    ...
    def start_requests(self):
        ...
        for url in start_urls:
            yield scrapy.Request(url, callback=self.parse_page, headers=self.headers, meta={'dont_redirect': True, 'proxy': self.proxies})
